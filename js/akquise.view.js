/* ============================================================================
   SwissSTR — akquise.view.js  ·  Akquise-Seite, GEKAPSELT (Deal-Engine + Agent-Loop)
   ----------------------------------------------------------------------------
   Stufe 2. Führt die in Schritt 6 getrennten js/akquise.deal.js + js/akquise.agent.js
   wieder zu EINEM gekapselten Modul zusammen — bewusst: die beiden teilen sich
   veränderlichen State (_dossPitchVariant, AKQWORK, _akqState, AKQ_F) und rufen sich
   gegenseitig auf; sie waren nie wirklich trennbar (vor Schritt 6 EIN Inline-Skript).
   Getrennte IIFEs hätten den geteilten State desynchronisiert. In EINER IIFE ist das
   Verhalten exakt das des ursprünglichen Inline-Skripts — nur global dicht.

   ÖFFENTLICHE API = die 18 Handler ganz unten (Inline-/generierte onclick im HTML
   brauchen bare Namen). Alle übrigen Funktionen + State sind jetzt privat. Die klar
   getrennten Sektionen DEAL-ENGINE / AGENT-LOOP bleiben als Banner erhalten.

   Non-strict (wie das Original). Geladen NACH SwissFmt, SwissCohort, js/data.js
   (markets/coords), js/loopholes.js, STREcon.
   ========================================================================== */
(function () {
/* ==================== DEAL-ENGINE (Markt/Kohorte/Dossier/Brief) ==================== */
...
/* ==================== AGENT-LOOP + ORCHESTRIERUNG + BOOT ==================== */
  ...
  /* ---- OEFFENTLICHE API: nur die Handler, die Inline-/generierte onclick im HTML brauchen.
     Alle uebrigen Funktionen + State dieser IIFE bleiben privat. Diese Liste IST die Schnittstelle. ---- */
  Object.assign(window, {
    dossLetter, closeLetter, copyLetter, emailLetter, generateLetter, gmailLetter, openMarket,
    akqGmail, akqOvApprove, akqSaveLandlordOnly, akqSetStatus, akqGiveLeadToAgent, akqRenderOverview,
    initAkquise, akqAddVerwaltung, akqApprove, akqCompose, akqSelectLead
  });
})();
